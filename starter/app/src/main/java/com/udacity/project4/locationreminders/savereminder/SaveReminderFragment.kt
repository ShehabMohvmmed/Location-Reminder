...
private const val BACKGROUND_LOCATION_PERMISSION = 1
private const val REQUEST_TURN_DEVICE_LOCATION_ON = 29
private const val REQUEST_FOREGROUND_AND_BACKGROUND_PERMISSION = 33
private const val REQUEST_FOREGROUND_ONLY_PERMISSIONS = 34
...
class SaveReminderFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.saveReminder.setOnClickListener {
            ...
            if (_viewModel.validateEnteredData(reminderDataItem)){
                if (onForegroundAndBackgroundLocationPermissionApproved()){
                    checkDeviceLocationSettingsAndStartGeofence()
                } else {
                    onRequestForegroundAndBackgroundLocationPermissions()
                }
            }
        }
    }
    ...
    @RequiresApi(Build.VERSION_CODES.Q)
    private fun onRequestForegroundAndBackgroundLocationPermissions() {
        if (onForegroundAndBackgroundLocationPermissionApproved())
            return
        ...
        val requestCode = when {
            ...
            else -> REQUEST_FOREGROUND_ONLY_PERMISSIONS
        }
    ...
    @RequiresApi(Build.VERSION_CODES.Q)
    private fun onForegroundAndBackgroundLocationPermissionApproved(): Boolean {
    ...
    override fun onRequestPermissionsResult(
        ...
        if (
            ...
            grantResults[LOCATION_PERMISSION] == PackageManager.PERMISSION_DENIED ||
            (requestCode == REQUEST_FOREGROUND_AND_BACKGROUND_PERMISSION &&
                    grantResults[BACKGROUND_LOCATION_PERMISSION] ==
